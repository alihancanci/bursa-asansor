module.exports=[85537,a=>{"use strict";var b=a.i(81595),c=a.i(31932),d=a.i(94412),e=a.i(28920);let f=[{id:"1",slug:"2026-evden-eve-nakliyat-rehberi",title:"2026 Evden Eve Nakliyat Rehberi: Fiyatlar ve Dikkat Edilmesi Gerekenler",excerpt:"Evden eve nakliyat sürecinde maliyetleri nasıl düşürebilirsiniz? 2026 yılı güncel nakliye fiyatları, asansörlü taşıma avantajları ve doğru firma seçimi için kapsamlı rehber.",date:"24 Mart 2026",readTime:"6 dk okuma",category:"Nakliyat Rehberi",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/hero-bg.png",metaDescription:"2026 evden eve nakliyat fiyatları ne kadar? Taşınırken maliyeti düşürmenin yolları ve asansörlü taşımacılığın avantajları. Detaylı nakliyat rehberi.",keywords:["evden eve nakliyat","nakliyat fiyatları 2026","asansörlü nakliyat","taşınma rehberi","bursa evden eve nakliyat","paketleme","güvenilir taşıma"],content:`
    ...
    `},{id:"2",slug:"neden-asansorlu-tasimacilik-avantajlari",title:"Neden Asansörlü Taşımacılık? (Maliyet ve Zaman Analizi)",excerpt:"Gökdelen ve rezidans taşımalarında neden dış cephe asansörü kullanmalısınız? Mobil asansör kiralamanın maliyet, hız ve güvenlik açısından faydaları nelerdir?",date:"25 Mart 2026",readTime:"5 dk okuma",category:"Lojistik & Teknoloji",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/service-abstract.png",metaDescription:"Asansörlü taşımacılık nedir? Kiralık asansör fiyatları maliyetli mi? Dış cephe asansör kurulumunun zaman tasarrufu ve güvenlik avantajları hakkında detaylar.",keywords:["asansörlü taşımacılık","kiralık asansör fiyatları","mobil asansör kiralama","dış cephe asansörü","bina merdiven koruması","eşya taşıma güvenliği"],content:`
      <h2>Taşımacılık Sekt\xf6r\xfcnde Evrim: Dış Cephe Asans\xf6rleri</h2>
      <p>Şehir hayatında giderek y\xfckselen binalar, daralan apartman boşlukları ve k\xfc\xe7\xfck bina i\xe7i asans\xf6rler... Eşya ve malzeme taşıma işlemini bir k\xe2bus haline d\xf6n\xfcşt\xfcren bu yapısal engeller, lojistik sekt\xf6r\xfcnde yepyeni bir standardı doğurdu: <strong>Asans\xf6rl\xfc Taşımacılık</strong>.</p>
      
      <p>\xd6zellikle inşaat (LSI: tuğla, \xe7imento, al\xe7ıpan transferi) ve yapı sekt\xf6r\xfcnde, ya da ev taşıma s\xfcre\xe7lerinde bina i\xe7ini kullanmadan, \xfcr\xfcnleri doğrudan a\xe7ık bir pencere veya balkondan yukarı taşımanın benzersiz avantajları vardır.</p>
    ...
    `},{id:"3",slug:"tasinma-oncesi-kontrol-listesi-adim-adim-stresten-kurtulun",title:"Taşınma Öncesi Kontrol Listesi: Adım Adım Stresten Kurtulun",excerpt:"Sorunsuz bir taşınma süreci için 1 ay öncesinden yapmanız gerekenleri bir araya getirdik. Abonelik devirleri, eşya ayrıştırma, kolileme stratejileri ve taşıma şirketi rezervasyonu.",date:"26 Mart 2026",readTime:"4 dk okuma",category:"Taşınma Planlaması",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/hero-bg.png",metaDescription:"Taşınma telaşından kurtulmak için en iyi kontrol listesi. Abonelik işlemleri, eşya paketleme taktikleri ve kurumsal nakliyat firması bulma rehberi.",keywords:["taşınma işlemleri","abonelik taşıma","eşya paketleme listesi","stres olmadan taşınmak","ofis taşıma ipuçları","yeni eve taşınırken"],content:`
      ...
      <p>Koli fırtınası burada başlıyor. Kitaplar, s\xfcs eşyaları, yazın ortasında taşınıyorsanız kışlık kabanlar gibi acil ihtiyacınız olmayan eşyaları \xf6nceden paketleyin.</p>
    ...
    `},{id:"4",slug:"asansor-kiralama-nasil-yapilir",title:"Asansör Kiralama Nasıl Yapılır? Adım Adım Rehber",excerpt:"Dış cephe mobil asansör kurulumu, operatör belgesi zorunlulukları ve adım adım güvenli rezervasyon sürecinin tüm teknik detayları.",date:"27 Mart 2026",readTime:"7 dk okuma",category:"Lojistik & Teknoloji",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/service-abstract.png",metaDescription:"Asansör kiralama nasıl yapılır? Dış cephe asansörü kurulumu, operatör belgesi ve güvenlik adımları. Bursa'da hızlı kiralama rehberi.",keywords:["asansör kiralama nasıl yapılır","operatör belgesi","dış cephe asansörü","mobil asansör kurulumu","bursa asansör kiralama"],faqs:[{q:"Asansörü ben kullanabilir miyim?",a:"Hayır. Yasal zorunluluklar ve iş güvenliği gereği asansörü sadece kurumumuzun yetkili ve belgeli operatörü kullanabilir."},{q:"Sistemin kurulması ne kadar sürer?",a:"Sokak veya cadde uygunsa, hidrolik ayakların sabitlenmesi ve platformun uzatılması ortalama 15-25 dakika sürer."},{q:"Hangi saatlerde kiralama yapılıyor?",a:"7/24 hizmet veriyoruz. İster sabahın erken saatlerinde ister gece mesaisinde kiralık asansör talebinde bulunabilirsiniz."}],content:`
      <h2>Mobil Asans\xf6r Kiralama S\xfcrecine Giriş</h2>
      <p>Y\xfcksek katlı binalara taşınırken veya ağır inşaat malzemelerini binalara \xe7ıkarırken <strong>dış cephe asans\xf6r\xfc</strong> kullanmak artık bir standart haline geldi. Peki, "<strong>Asans\xf6r kiralama nasıl yapılır?</strong>" ve bu s\xfcrecin arkasındaki g\xfcvenlik mekanizmaları nelerdir? İster bireysel kullanıcı olun, ister bir inşaat firması y\xf6neticisi; profesyonel bir <a href="/osmangazi-kiralik-mobil-asansor" class="text-primary font-semibold hover:underline">kiralık mobil asans\xf6r</a> hizmetinin adımlarını bilmek zaman ve para kayıplarını \xf6nler.</p>
      
      <h3>1. Adım: Keşif ve Rezervasyon</h3>
      <p>Her şey bir WhatsApp mesajı veya telefon aramasıyla başlar. Binanızın konumu (\xd6rneğin; Nil\xfcfer, \xd6zl\xfcce mevkii), ka\xe7ıncı katta işlem yapılacağı ve taşınacak malzemenin (beyaz eşya, moloz, tuğla vb.) cinsi bildirilir. Alanında uzman ekibimiz Google Haritalar \xfczerinden veya fiili olarak sokağınızın genişliğini, ağa\xe7 engelini ve elektrik telleri gibi risk fakt\xf6rlerini analiz eder. Uygunluk onayı verildikten sonra saat ve tarih netleştirilir.</p>

      <h3>2. Adım: İzinler ve \xc7evre G\xfcvenliği</h3>
      <p>\xd6zellikle ana caddelerde veya dar sokaklarda kurulum yapılacaksa, trafiğin g\xfcvenliğini sağlamak esastır. Gerekirse duba ve emniyet şeritleriyle \xe7alışma alanı izole edilir. Y\xfcksek ağırlık merkezine sahip olan <strong>teleskopik asans\xf6r</strong> kasası, şasedeki d\xf6rt hidrolik "denge ayağı" sayesinde milimetrik olarak sabitlenir. Bu ayaklardan biri bile tam basmazsa sistem g\xfcvenlik sens\xf6rleri sebebiyle \xe7alışmaya başlamaz.</p>

      <h3>3. Adım: Kurulum ve Operat\xf6r Belgesi Zorunluluğu</h3>
      <p>\xd6nemli bir teknik detay: Piyasada ucuza iş yapan yetkisiz kişilerin iddialarının aksine, bu makineleri herkes kullanamaz. Sekt\xf6r standardı olan iş g\xfcvenliği kanunları gereğince <strong>operat\xf6r belgesi</strong> (kaldırma ve y\xfckleme emniyeti sertifikasyonu) zorunludur. İşlem esnasında operat\xf6r başından bir saniye bile ayrılmaz; r\xfczgar şiddetini, sepetin ağırlık dağılımını (load distribution) ve halat gerginliğini s\xfcrekli monit\xf6r\xfcnden takip eder.</p>
    ...
    `},{id:"5",slug:"kacinci-kata-kadar-cikar",title:"Mobil Asansörler Kaçıncı Kata Kadar Çıkar?",excerpt:"Teleskopik asansörlerin teknik limitleri. 15., 20. veya 25. katlar için güvenlik sınırları, rüzgar hızı toleransı ve yükseklik fiziği.",date:"28 Mart 2026",readTime:"7 dk okuma",category:"Lojistik & Teknoloji",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/hero-bg.png",metaDescription:"Mobil asansörler kaçıncı kata çıkar? Yüksek kat eşya taşıma asansörlerinin erişim limitleri, 15-20-25 kat kuralları ve rüzgar güvenliği.",keywords:["kaçıncı kata kadar çıkar","yüksek kat eşya taşıma asansörü","teleskopik asansör","asansör kiralama sınırları","rüzgar güvenliği"],faqs:[{q:"Sizin cihazlarınız maksimum kaçıncı kata erişiyor?",a:"Bursa sınırları içinde hizmet verdiğimiz araç parkurumuz güvenilir şekilde 15. kata kadar erişim sağlamaktadır."},{q:"Yüksek katlarda balkon şart mı?",a:"Balkon taşıma için en uygun alandır ancak yere kadar inen geniş Fransız camlar veya çift kanat sökülebilen pencereler de sıklıkla kullanılmaktadır."},{q:"Çok rüzgârlı havalarda sorun olur mu?",a:"Asansörlerimiz rüzgar sensörlerine sahiptir. Emniyet limitlerini aşan şiddetli rüzgarlarda operatörümüz işlemi durdurma yetkisine tam olarak sahiptir."}],content:`
      ...
      <p>T\xfcrkiye'de ve Avrupa'da standart dış cephe nakliyat asans\xf6rleri ortalama 15. ile 18. kata kadar hizmet verebilecek şekilde tasarlanmıştır. Ortalama 45-50 metre bom uzunluğuna (a\xe7ılabilir merdiven mekanizması) sahip bu makineler, şehirlerarası lojistik ve inşaat uygulamalarında altın standardı belirler.</p>
      ...
      <p>Yerden 45 metre y\xfcksekte hava akımları, zemine kıyasla \xe7ok daha serttir. <strong>Dış cephe asans\xf6r\xfc</strong> platformu a\xe7ıldığında bir yelken g\xf6revi g\xf6r\xfcr. İş g\xfcvenliği kurallarına g\xf6re:</p>
      <ul class="list-disc pl-5 mt-4 space-y-2">
    ...
    `},{id:"6",slug:"asansor-vs-vinc-karsilastirma",title:"Asansör vs. Vinç? İnşaat Lojistiğinde Karşılaştırma",excerpt:"Ağır malzeme transferinde hangisi daha kârli? Dış cephe asansörlerinin kule vinç veya mobil vinçlere göre avantajları, hız testi ve fiyat/performans tablosu.",date:"29 Mart 2026",readTime:"8 dk okuma",category:"Lojistik & Teknoloji",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/service-abstract.png",metaDescription:"Asansör mü vinç mi? İnşaat lojistiğinde dış cephe asansörlerinin hız, maliyet ve iş güvenliği avantajları. Kapsamlı mobil asansör vs vinç karşılaştırması.",keywords:["asansör vs vinç","inşaat asansörü","dış cephe asansörü","moloz indirme asansörü","eşya taşıma vinç fiyatları","cephe camı taşıma"],faqs:[{q:"Kaç tona kadar malzeme çıkarabilir?",a:"Vinçler tonlarca ağırlığı kaldırabilirken, mobil asansörlerin sepeti yaklaşık 300-400 kg kapasitelidir. Fakat asansörler peşpeşe sürekli tur atarak (seri transfer) günlük tonaja ulaşmada vinçleri yenebilir."},{q:"Kurulum süresi hangisinde daha kısadır?",a:"Tartışmasız mobil asansör. Araç sokağa girer, 20 dakikada kurulur ve anında malzeme taşıtmaya başlar. Vinçlerde denge ve sapan bağlama işlemleri uzun sürer."},{q:"Risk açısından hangisi daha emniyetlidir?",a:"Asansörler kapalı/korkuluklu bir platformda ray üzerinde gidip geldiği için, malzemelerin sallanarak çarpma riski sıfırdır. Vinçlerde havada salınım riski yüksektir."}],content:`
      <h2>Y\xfcksek Kat Maliyet Savaşları: Asans\xf6r m\xfc, Vin\xe7 mi?</h2>
      <p>\xd6zellikle inşaat projelerinde, restorasyonlarda ve hacimli ofis taşımalarında projeyi y\xf6neten m\xfchendislerin ve y\xf6neticilerin aklında tek soru vardır: <strong>Malzemeyi vin\xe7le mi basmalıyım, yoksa dış cephe asans\xf6r\xfc m\xfc kiralamalıyım?</strong></p>
    ...
    `},{id:"7",slug:"tasinirken-asansor-zorunlu-mu",title:"Apartmanda Taşınırken Asansör Kullanmak Zorunlu mu?",excerpt:"Yeni bir eve taşınırken site yönetimlerinin bina içi asansör yasakları. Apartman merdivenlerinde taşıma stresi ve dış cephe kullanımının hukuki boyutu.",date:"30 Mart 2026",readTime:"6 dk okuma",category:"Taşınma Planlaması",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/hero-bg.png",metaDescription:"Taşınırken asansör zorunlu mu? Site yönetimi bina içi asansörü yasaklayabilir mi? Dış cephe asansörü kiralama ve apartman kuralları hakkında bilmeniz gerekenler.",keywords:["taşınırken asansör zorunlu mu","bina içi asansör yasakları","site yönetimi kuralları","dış cephe asansörü kurulumu","mobilya asansörü kiralamak","apartman kuralları"],faqs:[{q:"Yönetici apartmanın asansörünü taşınmaya kapatabilir mi?",a:"Evet. Kat Mülkiyeti Kanunu ve genel ahlak kuralları çerçevesinde yönetim planına 'Bina asansöründe (yolcu asansörü) yük taşımak yasaktır' maddesi eklenmişse kullanımını engelleyebilir."},{q:"Oturduğum ev 2. katta, yine de asansör kurmak mantıklı mı?",a:"Binanızın merdiven boşluğu genişse beden gücüyle taşınabilir. Ancak merdivenler darsa, 2. kat bile olsa büyük mobilyalarınızın hasar görmemesi için asansör kurulması tavsiye edilir."},{q:"Sokak çok dar, asansör sığar mı?",a:"Uzmanlarımız ücretsiz keşif yapar. Ufak manevralar veya hafif açılı kurulum ile pek çok zorlu sokağa asansör kurabiliyoruz."}],content:`
      <h2>Taşınırken Karşılaşılan B\xfcrokrasi: Site Y\xf6netimleri</h2>
      ...
      <p>Maliyet olarak bakıldığında, "Taşımacılar elle merdivenden \xe7ıkarsın" diyebilirsiniz. Ancak bu sefer de 10. kattaki dairenize \xe7ıkartılan bir eşyanın \xe7arpıp kırılması muhtemeldir. Dış cephe asans\xf6r\xfc bu gibi kullanıcı (hamal) hatalarını engeller. Kendi yatırımınızı korumak i\xe7in dış cephe sisteminin sağladığı g\xfcvenliğe sığınmak, uzun vadede daima "ucuz" bir yatırımdır.</p>
    `},{id:"8",slug:"bursa-en-ucuz-ve-kaliteli-nakliyat-hizmeti",title:"Bursa'nın En Ucuz ve Kaliteli Hizmeti Nasıl Bulunur?",excerpt:"Fiyat/performans analizi. Merdiven altı nakliyat firmalarının sinsi maliyet tuzakları. Profesyonel asansör kuruluşu seçerken sorulması gereken 5 soru.",date:"01 Nisan 2026",readTime:"6 dk okuma",category:"Nakliyat Rehberi",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/hero-bg.png",metaDescription:"Bursa'nın en ucuz ve en kaliteli nakliyat asansörü hizmetleri. Evden eve taşımacılıkta gizli maliyetlerden nasıl kurtulursunuz? Profesyonel hizmet rehberi.",keywords:["bursa ucuz asansör kiralama","kaliteli nakliyat hizmeti bursa","gizli taşıma maliyetleri","asansörlü ev taşıma fiyatları","profesyonel evden eve nakliyat"],faqs:[{q:"Telefonda verilen fiyat sonradan değişir mi?",a:"Kurumsal firmalarda (bizim gibi) keşif sonrası anlaşılan fiyat nettir. Merdiven altı şirketlerde ise eşya kapıdan çıkınca 'buna asansör lazım, ek 2000 TL' denilir."},{q:"Sadece asansör değil, komple nakliye hizmeti yapıyor musunuz?",a:"Elbette. Kamyon, personel, ambalajlama ve mobil asansör dahil anahtar teslim taşıma yapıyoruz."},{q:"En ucuz hizmeti seçmek mantıklı mıdır?",a:"Piyasa ortalamasının çok altına fiyat çeken firmalar genelde eşyalarınızı kalitesiz donanım ve eğitimsiz personellerle (yabancı kaçak uyruklu vb.) taşıtarak sizi riske atarlar."}],content:`
      <h2>Ucuz Etin Yahnisi: Nakliyat Sekt\xf6r\xfcndeki Tuzaklar</h2>
      <p>Taşınma stresi i\xe7indeyken internete girdiğinizde onlarca nakliyat ilanı g\xf6r\xfcrs\xfcn\xfcz. "Bursa'nın en ucuz asans\xf6r\xfc", "bedavaya taşıyoruz" gibi agresif pazarlama taktikleri aklınızı \xe7elebilir. Ancak <strong>"Bursa'nın en ucuz ve kaliteli hizmeti"</strong> arayışı, mantıkla hareket edilmediğinde b\xfcy\xfck felaketlerle son bulur.</p>
      ...
      <p>Ger\xe7ekten kaliteli ve s\xfcrd\xfcr\xfclebilir bir fiyat/performans istiyorsanız, kurumsal işleyişi olan firmalarla (Bkz: hizmet kalitemiz <a href="/bursa-merkez-kiralik-mobil-asansor" class="text-primary font-semibold hover:underline">Bursa Kiralık Asans\xf6r ve Evden Eve Nakliyat</a>) masaya oturmalısınız.</p>
    ...
    `},{id:"9",slug:"ucretsiz-ekspertiz-ile-surpriz-maliyetlere-son",title:"Ücretsiz Ekspertiz ile Taşınırken Sürpriz Maliyetlere Son",excerpt:"Eşyalarınızın güvenliği ve net fiyatlandırma için neden ücretsiz ekspertiz (yerinde keşif) hizmeti talep etmelisiniz? Stres olmadan, mutlu bir şekilde taşınmanın altın kuralı.",date:"02 Nisan 2026",readTime:"5 dk okuma",category:"Taşınma Planlaması",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/mutlu-aile-tasinma.png",metaDescription:"Bursa ücretsiz ekspertiz, yerinde keşif hizmeti ile asansörlü nakliyatta sürpriz fiyatlarla karşılaşmayın. Eşyalarınızı güvenle taşımak için uzman eksper isteyin.",keywords:["ücretsiz ekspertiz","ücretsiz keşif","yerinde keşif bursa","asansörlü evden eve nakliyat keşif","sürpriz maliyet yok","stres olmadan taşınmak"],faqs:[{q:"Ücretsiz ekspertiz ne işe yarar?",a:"Uzman personelimiz adresinize gelerek eşyalarınızın hacmini, asansörün kurulacağı cepheyi ve rüzgar durumunu inceler. Böylece taşınma günü aksilik ve ekstra fiyat çıkmaz."},{q:"Ekspertiz için ücret talep ediliyor mu?",a:"Hayır. Bursa Kiralık Asansör ve Evden Eve Nakliyat olarak tüm Bursa ilçelerinde ekspertiz hizmetimizi %100 ücretsiz olarak sunuyoruz."}],content:`
      ...
      <p>Telefonda afak\xee fiyat veren "merdiven altı" nakliyat\xe7ılar genellikle işi alabilmek i\xe7in maliyeti d\xfcş\xfck g\xf6sterirler. Taşıma g\xfcn\xfc kapınıza geldiklerinde ise asans\xf6r\xfcn sığmadığını bahane edip s\xfcreci kilitlerler. \xdccretsiz ekspertiz, sizi bu amat\xf6rl\xfcklerden korur.</p>
    ...
    `},{id:"evden-eve-tasinma-rehberi",slug:"bursa-evden-eve-tasinma-rehberi-stressiz-nakliyat",title:"Bursa Evden Eve Taşınma Rehberi: Stressiz Bir Nakliyat İçin İpuçları",excerpt:"Ev değiştirmek yorucu mu geliyor? Bursa'da evden eve nakliyat sürecini sıfır hasar ve sıfır stresle atlatmanın en pratik yollarını ve dikkat etmeniz gerekenleri derledik.",date:"2024-03-25",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",readTime:"6 dk okuma",category:"Taşınma Rehberi",image:"/images/mutlu-aile-tasinma.png",metaDescription:"Bursa evden eve nakliyat rehberi. Asansörlü taşımacılık, güvenli nakliyat ve pratik kolileme ipuçlarıyla stressiz taşının.",keywords:["bursa evden eve nakliyat","asansörlü evden eve","bursa ev taşıma","stressiz taşınma rehberi","bursa nakliyat firmaları"],content:`
      <h2>Evden Eve Taşınma S\xfcrecini Nasıl Kolaylaştırırsınız?</h2>
      <p>Bursa gibi kalabalık, trafiği yoğun ve binaların giderek y\xfckseldiği bir şehirde <strong>evden eve taşınma</strong> s\xfcreci pek \xe7ok aile i\xe7in kabusa d\xf6n\xfcşebiliyor. Eşyaların kırılması, zamanın uzaması veya ekstra masraflar en sık karşılaşılan sorunlar arasında. Ancak doğru bir planlama ve profesyonel destekle bu s\xfcreci keyifli bir yeni başlangıca d\xf6n\xfcşt\xfcrmek elinizde.</p>

      <h3>1. Taşınma Planınızı Erkenden Yapın</h3>
      <p>Nakliye g\xfcn\xfcnden en az 2 hafta \xf6nce hazırlıklara başlamalısınız. Kullanmadığınız eşyaları ayıklamak, kolileme stratejisi belirlemek ve en \xf6nemlisi doğru nakliyat firmasını se\xe7mek i\xe7in zaman kazanmış olursunuz.</p>
    ...
    `},{id:"frase-asansorlu-nakliyat",slug:"asansorlu-evden-eve-nakliyat",title:"Bursa Asansörlü Evden Eve Nakliyat: Kolay ve Güvenli Taşıma",excerpt:"Yüksek katlı binalarda asansörlü evden eve nakliyat ile eşyalarınızı güvenle taşıyın. Profesyonel hizmetle stres ve masrafları azaltın!",date:"07 Nisan 2026",author:"Atakan",readTime:"8 dk okuma",category:"Lojistik & Teknoloji",image:"/images/asansorlu-tasima-bursa-hero.jpg",metaDescription:"Yüksek katlı binalarda asansörlü evden eve nakliyat ile eşyalarınızı güvenle taşıyın. Profesyonel hizmetle stres ve masrafları azaltın!",keywords:["asansörlü evden eve nakliyat","teleskopik asansör","bursa kiralık asansör","asansörlü taşıma fiyatları","yüksek kat nakliyat"],faqs:[{q:"Asansörlü nakliyat her binada kullanılabilir mi?",a:"Hayır. Binanın cephesine yeterli mesafe, zemin sağlamlığı ve park alanı gibi teknik koşullar gereklidir. Taşıma öncesinde firma yerinde keşif yaparak uygunluğu değerlendirir."},{q:"Eşyalar ne kadar güvende?",a:"Asansörlü sistem, merdiven taşımacılığına kıyasla çizilme ve kırılma riskini önemli ölçüde azaltır. Bununla birlikte, sözleşme ve sigorta poliçesi güvenliği %100'e taşır."},{q:"Rezervasyon ne kadar önceden yapılmalı?",a:"Yoğun dönemlerde (ay başı/sonu) en az 1 hafta önceden randevu alınması önerilir. Bu, planlama sürecini daha verimli yönetmeyi sağlar."},{q:"Kötü hava koşullarında taşıma yapılır mı?",a:"Güçlü rüzgar veya yoğun yağışta asansör operasyonu işçi ve çevre güvenliği gerekçesiyle ertelenebilir."}],content:`
      ...
      <p>T\xfcrkiye'de kentsel d\xf6n\xfcş\xfcm ve yeni yapı stoğunun artmasıyla birlikte bu hizmete olan talep de belirgin şekilde y\xfckselmektedir. Peki asans\xf6rl\xfc nakliyat ger\xe7ekten her durum i\xe7in doğru tercih midir? Avantajları ve olası dezavantajlarıyla birlikte değerlendirmek gerekir.</p>

      <h2>Asans\xf6rl\xfc Nakliyatın Avantajları ve Dezavantajları</h2>
      <p><strong>Evden eve taşıma</strong> s\xfcrecinde asans\xf6rl\xfc sistem tercih etmek, bir\xe7ok somut fayda sunar. Ancak her \xe7\xf6z\xfcmde olduğu gibi, dikkat edilmesi gereken bazı sınırlılıklar da mevcuttur.</p>
    ...
    `}];var g=a.i(32855),h=a.i(53192),i=a.i(82878);a.s(["default",0,function(){return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(i.Breadcrumbs,{items:[{name:"Blog",path:"/blog"}]}),(0,b.jsx)("section",{className:"pt-32 pb-16 bg-slate-50 dark:bg-navy/30 border-b border-slate-200 dark:border-white/10",children:(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center",children:[(0,b.jsxs)(e.motion.h1,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},className:"text-4xl md:text-5xl font-display font-bold mb-6 text-secondary dark:text-white",children:["Nakliyat & ",(0,b.jsx)("span",{className:"text-primary",children:"Taşınma Rehberi"})]}),(0,b.jsx)(e.motion.p,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.1},className:"text-lg text-slate-700 dark:text-slate-300 max-w-2xl mx-auto",children:"Türkiye'nin en kapsamlı asansörlü taşımacılık ve evden eve nakliyat bilgi arşivi. Sorunsuz bir taşınma süreci için uzman tavsiyeleri."})]})}),(0,b.jsx)("section",{className:"py-20 bg-white dark:bg-background",children:(0,b.jsx)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",children:f.map((a,f)=>(0,b.jsxs)(e.motion.article,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.1*f+.2},className:"group flex flex-col bg-white dark:bg-navy-light rounded-3xl border border-border dark:border-white/10 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1",children:[(0,b.jsxs)(c.default,{href:`/blog/${a.slug}`,className:"block h-48 overflow-hidden relative",children:[(0,b.jsx)("div",{className:"absolute inset-0 bg-primary/20 group-hover:bg-transparent transition-colors z-10"}),(0,b.jsx)(d.default,{src:a.image,alt:a.title,fill:!0,className:"object-cover transform group-hover:scale-105 transition-transform duration-500",sizes:"(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"}),(0,b.jsx)("div",{className:"absolute top-4 left-4 z-20 bg-white/90 backdrop-blur text-secondary px-3 py-1 rounded-full text-xs font-bold shadow-sm",children:a.category})]}),(0,b.jsxs)("div",{className:"p-6 flex flex-col flex-1",children:[(0,b.jsx)(c.default,{href:`/blog/${a.slug}`,children:(0,b.jsx)("h2",{className:"text-xl font-bold mb-3 text-secondary dark:text-white group-hover:text-primary transition-colors line-clamp-2",children:a.title})}),(0,b.jsx)("p",{className:"text-slate-800 dark:text-slate-400 text-sm mb-6 line-clamp-3",children:a.excerpt}),(0,b.jsx)("div",{className:"mt-auto pt-4 border-t border-slate-100 dark:border-white/10 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400",children:(0,b.jsxs)("div",{className:"flex items-center gap-4",children:[(0,b.jsxs)("span",{className:"flex items-center gap-1",children:[(0,b.jsx)(g.Calendar,{className:"w-3 h-3"})," ",a.date]}),(0,b.jsxs)("span",{className:"flex items-center gap-1",children:[(0,b.jsx)(h.Clock,{className:"w-3 h-3"})," ",a.readTime]})]})})]})]},a.id))})})})]})}],85537)}];

//# sourceMappingURL=Desktop_yedek_src_app_blog_BlogIndexClient_tsx_0e9m6z-._.js.map