module.exports=[24022,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(85650).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/Desktop/yedek/src/app/blog/[slug]/BlogPostClient.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/Desktop/yedek/src/app/blog/[slug]/BlogPostClient.tsx <module evaluation>","default")},72678,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(85650).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/Desktop/yedek/src/app/blog/[slug]/BlogPostClient.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/Desktop/yedek/src/app/blog/[slug]/BlogPostClient.tsx","default")},205,a=>{"use strict";a.i(24022);var b=a.i(72678);a.n(b)},3327,a=>{"use strict";var b=a.i(85752);let c=[{id:"1",slug:"2026-evden-eve-nakliyat-rehberi",title:"2026 Evden Eve Nakliyat Rehberi: Fiyatlar ve Dikkat Edilmesi Gerekenler",excerpt:"Evden eve nakliyat sürecinde maliyetleri nasıl düşürebilirsiniz? 2026 yılı güncel nakliye fiyatları, asansörlü taşıma avantajları ve doğru firma seçimi için kapsamlı rehber.",date:"24 Mart 2026",readTime:"6 dk okuma",category:"Nakliyat Rehberi",author:"Bursa Kiralık Asansör ve Evden Eve Nakliyat Ekibi",image:"/images/hero-bg.png",metaDescription:"2026 evden eve nakliyat fiyatları ne kadar? Taşınırken maliyeti düşürmenin yolları ve asansörlü taşımacılığın avantajları. Detaylı nakliyat rehberi.",keywords:["evden eve nakliyat","nakliyat fiyatları 2026","asansörlü nakliyat","taşınma rehberi","bursa evden eve nakliyat","paketleme","güvenilir taşıma"],content:`
    ...
    `}];var d=a.i(205);async function e(){return c.map(a=>({slug:a.slug}))}async function f({params:a}){let{slug:b}=await a,d=c.find(a=>a.slug===b);return d?{title:`${d.title} | Blog`,description:d.excerpt.length>155?`${d.excerpt.substring(0,155)}...`:d.excerpt,keywords:d.keywords,alternates:{canonical:`/blog/${b}`},openGraph:{title:d.title,description:d.excerpt.length>155?`${d.excerpt.substring(0,155)}...`:d.excerpt,type:"article",url:`/blog/${d.slug}`,publishedTime:d.date,authors:[d.author]},twitter:{card:"summary_large_image",title:d.title,description:d.excerpt}}:{title:"Yazı Bulunamadı | Blog"}}async function g({params:a}){let{slug:e}=await a,f=c.find(a=>a.slug===e);if(!f)return null;let h="asansorlu-evden-eve-nakliyat"===f.slug?{"@context":"https://schema.org","@graph":[{"@type":"Article",url:`https://bursakiralikasansor.com/blog/${f.slug}`,headline:f.title,description:f.metaDescription,author:{"@type":"Person",name:"Atakan"},publisher:{"@type":"Organization",name:"Bursa Kiralık Asansör ve Evden Eve Nakliyat",logo:{"@type":"ImageObject",url:"https://bursakiralikasansor.com/favicon.svg"}},datePublished:"2026-04-06T23:39:19Z",image:f.image},{"@type":"FAQPage",mainEntity:f.faqs?.map(a=>({"@type":"Question",name:a.q,acceptedAnswer:{"@type":"Answer",text:a.a}}))},{"@type":"HowTo",name:"Asansörlü Evden Eve Nakliyat Süreci",description:f.excerpt,step:[{"@type":"HowToStep",position:1,text:"Ücretsiz keşif ile taşıma planı oluşturulması."},{"@type":"HowToStep",position:2,text:"Eşyaların profesyonel paketleme malzemeleriyle korunması."},{"@type":"HowToStep",position:3,text:"Mobil asansörün bina cephesine güvenli kurulumu."},{"@type":"HowToStep",position:4,text:"Eşyaların asansörle hasarsız şekilde sevkiyatı."}]}]}:null;return(0,b.jsxs)(b.Fragment,{children:[h&&(0,b.jsx)("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(h)}}),(0,b.jsx)(d.default,{post:f})]})}a.s(["default",0,g,"generateMetadata",0,f,"generateStaticParams",0,e],3327)},61930,a=>{a.n(a.i(3327))}];

//# sourceMappingURL=Desktop_yedek_src_app_blog_%5Bslug%5D_0t9rxrz._.js.map