...
export default function WorksPage() {
  ...
  return (
    <div className="pt-24 min-h-screen bg-slate-50 dark:bg-background">
      <SEO
        title={t('meta.works_title', 'Çalışmalarımız | Bursa Mobil Asansör')}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {WORKS.map((item, idx) => (
            <motion.div
              ...
              className="group"
            >
              <div className="aspect-[4/3] overflow-hidden rounded-3xl border border-border dark:border-white/10 bg-white dark:bg-navy shadow-lg hover:shadow-2xl transition-all duration-500">
                <img
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-20 p-12 text-center rounded-4xl bg-white dark:bg-navy-light border border-dashed border-border dark:border-white/10"
        >
