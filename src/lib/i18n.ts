...
const trTranslations = {
  ...
  hero: {
    ...
    subtitle: "Dar sokaklar, yüksek binalar dert değil! 15. kata kadar güvenli ve hızlı mobil asansör ve nakliyat çözümleri sunuyoruz. Hemen Ara: 0505 608 07 00",
