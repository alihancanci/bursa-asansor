...
export const DISTRICTS: District[] = [
  ...
  { 
    ...
    seoParagraph: "Osmangazi'de mobil dış cephe asansörü uygunluğu; binanın cephe erişimine, aracın kurulabileceği alana ve taşınacak eşyanın ölçülerine göre değerlendirilir. Hamitler, Yunuseli, Dikkaldırım ve Çekirge'deki adresiniz için kat bilgisini ve cephe fotoğrafını paylaşarak ön değerlendirme ve fiyat bilgisi isteyebilirsiniz.",
    localNote: "Osmangazi'deki yoğun caddelerde araç konumu ve çalışma alanı planı önemlidir. Randevu öncesinde mahalle, kat, cepheye erişim ve uygun tarih bilgisini paylaşın; kurulum uygunluğu adrese göre netleştirilsin.",
    latitude: 40.1917,
    longitude: 29.0611,
    wikidataId: "Q1001402",
  ...
  { 
    ...
    seoParagraph: "Nilüfer'de kiralık mobil asansör ararken önce binanın dış cephe erişimi, önündeki kurulum alanı ve taşınacak yükün ölçüleri kontrol edilmelidir. Özlüce, Balat, Görükle, İhsaniye ve Ataevler'deki adresiniz için kat ve eşya bilgilerini iletin; asansörün kurulup kurulamayacağı ve ücret bu bilgilere göre değerlendirilir.",
    localNote: "Nilüfer'deki site veya apartman taşımalarında yönetimin izin ve çalışma saati koşullarını önceden öğrenin. Cephe ve sokağın fotoğrafı, kat bilgisi ve planlanan tarih uygunluk değerlendirmesini hızlandırır.",
    latitude: 40.2185,
    longitude: 28.9481,
    wikidataId: "Q1001400",
  ...
  { 
    ...
    seoParagraph: "Yıldırım'da kiralık asansör için adresin yol eğimi, sokağın genişliği ve binanın cephe erişimi kurulum kararını etkileyebilir. Millet, Ertuğrulgazi, Teleferik ve Mesken çevresindeki adresiniz için konum, kat, taşınacak yük ve cephe fotoğrafını paylaşarak uygunluk ile fiyat bilgisi alın.",
    localNote: "Yıldırım'daki eğimli veya dar sokaklı adreslerde aracın güvenle durabileceği alan ayrıca değerlendirilmelidir. Randevu öncesinde sokak ve bina cephesinin güncel fotoğrafını, kat ve tarih bilgisiyle iletin.",
    latitude: 40.1834,
    longitude: 29.1235,
    wikidataId: "Q1010006",
  ...
  { 
    ...
    seoParagraph: "İnegöl mobilya sanayisinin ve yerel halkının ihtiyaçlarına özel saatlik asansör kiralama çözümleri üretiyoruz. Alanyurt, Mesudiye ve Mahmudiye gibi bölgelerdeki üretim atölyeleri, showroomlar veya yeni binalar için 15. kata kadar çıkan hidrolik asansörlerimizi kiralayabilirsiniz. İnegöl saatlik asansör kiralama talebiniz için adres, kat bilgisi ve taşınacak ürün (mobilya, inşaat malzemesi vb.) türünü WhatsApp hattımızdan ileterek 5 dakika içinde kolayca teklif alabilirsiniz.",
    localNote: "İnegöl saatlik asansör kiralama hizmetimizde, mobilyalarınızın hasar görmemesi için asansör sepetini özel koruma battaniyeleriyle kaplıyoruz. Kurulum uygunluğu ve anında fiyat teklifi almak için binanızın cephe fotoğrafını göndermeniz yeterlidir.",
    latitude: 40.0778,
    longitude: 29.5161,
    wikidataId: "Q819445",
    landmark: "İnegöl AVM"
  ...
  { 
    ...
    seoParagraph: "Gürsu'da mobil asansör kiralama talebinde ev eşyası, mobilya veya yapı malzemesi gibi yükün türü ve yaklaşık ölçüsü fiyat değerlendirmesi için gereklidir. Kurtuluş, Yenidoğan, İstiklal ve Zafer mahallelerindeki adresinizde cephe erişimi ve aracın kurulacağı alan da önceden kontrol edilmelidir.",
    localNote: "Gürsu'da ev taşıma veya malzeme aktarımı için teklif alırken yükün türünü, katı, adresi ve planlanan günü belirtin. Büyük ya da ağır parçalar varsa ölçü ve fotoğraf ekleyerek taşıma uygunluğunu önceden sorun.",
    latitude: 40.2185,
    longitude: 29.1956,
    wikidataId: "Q1025547",
  ...
  { 
    ...
    seoParagraph: "Mudanya'da kiralık dış cephe asansörü için Güzelyalı, Burgaz, Bademli, Halitpaşa veya Trilye'deki adresin cepheye ve sokağa erişimi değerlendirilir. Sahil ve yerleşim içindeki farklı yol koşulları nedeniyle konum, kat, yük bilgisi ve cephe fotoğrafını paylaşarak kurulum uygunluğu ile fiyatı önceden sorun.",
    localNote: "Mudanya'da adresin sokağı, park alanı ve bina cephesi asansör kurulumunu etkileyebilir. Özellikle dar sokak veya site içi adreslerde konumu ve güncel cephe fotoğrafını randevu talebiyle birlikte iletin.",
    latitude: 40.3756,
    longitude: 28.8821,
    wikidataId: "Q386994",
